...
function PageLogin() {
    const logo = Imagem("https://www.svgrepo.com/show/325799/student-graduation-dance.svg", "Logo da Aplicação");
    ...
    const rodape = Rodape("Copyrigth (C) 2024");
